Scenario Hunting is the quickest way to spike the design, to cover the model by safety net, and to fill the gap between design and implementation. Scenario Hunting leads to causal consistency assurance across design elements before starting write them as code. 
